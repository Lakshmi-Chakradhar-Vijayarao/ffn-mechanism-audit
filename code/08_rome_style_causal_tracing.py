"""
Paper 1 -- final-audit fix: replaces/extends the blunt difference-of-means
additive steering causal test (01/07_*_causal_patch.py) with a proper
ROME-style causal-tracing sweep (Meng et al. 2022, "Locating and Editing
Factual Associations in GPT"), addressing the elite-reviewer critique that
mean-shift steering is a weak causal instrument relative to the field's
...
OUT_PATH = ROOT / "results" / "rome_style_causal_tracing.json"
